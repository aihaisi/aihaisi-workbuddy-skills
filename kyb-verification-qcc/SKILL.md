<!-- QCC_ONLINE_EXPERIENCE_PLAN_V1
{
  ...
  "toolPolicy": "explicit",
  "requiredTools": [
    "mcp__qcc-company__get_company_by_query",
  ...
  "steps": [
    {
      "id": "kyb-identify",
      "label": "识别为银行 KYB 核验，锁定核验主体",
      "cap": "主体识别",
      "capabilityKeys": ["entity"],
      "toolNames": ["mcp__qcc-company__get_company_by_query"],
      "completeOn": "route_match"
    },
    {
      "id": "kyb-anchor",
      "label": "以统一社会信用代码锚定，排除名称近似主体",
      "cap": "主体识别",
      "dependsOn": ["kyb-identify"],
      "toolNames": ["mcp__qcc-company__verify_company_accuracy"]
    },
    {
      "id": "kyb-registration",
      "label": "核验工商登记：登记状态 / 法定代表人 / 注册资本",
      "cap": "工商数据",
      "dependsOn": ["kyb-anchor"],
      "capabilityKeys": ["registration", "ownership", "management", "history"],
      "toolNames": [
        "mcp__qcc-company__get_company_registration_info",
        "mcp__qcc-company__get_shareholder_info",
        "mcp__qcc-company__get_change_records",
        "mcp__qcc-company__get_key_personnel",
        "mcp__qcc-company__get_contact_info",
        ...
        "mcp__qcc-company__get_tax_invoice_info",
        ...
        "mcp__qcc-history__get_historical_dishonest",
        "mcp__qcc-history__get_historical_judgment_debtor",
        "mcp__qcc-history__get_historical_high_consumption_ban",
        "mcp__qcc-history__get_historical_business_exception",
        "mcp__qcc-history__get_historical_serious_violation",
        "mcp__qcc-history__get_historical_admin_penalty",
        "mcp__qcc-history__get_historical_equity_freeze",
        "mcp__qcc-history__get_historical_equity_pledge",
        "mcp__qcc-executive__get_executive_beneficial_owner",
        "mcp__qcc-executive__get_executive_controlled_companies"
      ]
    },
    {
      "id": "kyb-risk",
      "label": "扫描 34 类司法与经营风险，红线即熔断预警",
      "cap": "风险数据",
      "dependsOn": ["kyb-registration"],
      "capabilityKeys": ["risk", "operation"],
      "toolNames": [
        "mcp__qcc-risk__get_company_risk_scan",
        "mcp__qcc-risk__get_company_related_risk_scan",
        "mcp__qcc-risk__get_dishonest_info",
        "mcp__qcc-risk__get_business_exception",
        "mcp__qcc-risk__get_administrative_penalty",
        "mcp__qcc-risk__get_judgment_debtor_info",
        "mcp__qcc-risk__get_case_filing_info",
        "mcp__qcc-risk__get_judicial_documents",
        "mcp__qcc-risk__get_judicial_document_detail",
        "mcp__qcc-risk__get_high_consumption_restriction",
        "mcp__qcc-risk__get_equity_freeze",
        "mcp__qcc-risk__get_serious_violation",
        "mcp__qcc-risk__get_equity_pledge_info",
        "mcp__qcc-risk__get_court_notice",
        "mcp__qcc-risk__get_tax_arrears_notice",
        "mcp__qcc-risk__get_bankruptcy_reorganization",
        "mcp__qcc-risk__get_terminated_cases",
        "mcp__qcc-risk__get_tax_abnormal",
        "mcp__qcc-risk__get_hearing_notice",
        "mcp__qcc-risk__get_tax_violation",
        "mcp__qcc-risk__get_environmental_penalty",
        "mcp__qcc-risk__get_default_info",
        "mcp__qcc-risk__get_chattel_mortgage_info",
        "mcp__qcc-risk__get_judicial_auction",
        "mcp__qcc-risk__get_liquidation_info",
        "mcp__qcc-risk__get_service_announcement",
        "mcp__qcc-risk__get_exit_restriction",
        "mcp__qcc-risk__get_cancellation_record_info",
        "mcp__qcc-risk__get_land_mortgage_info",
        "mcp__qcc-risk__get_disciplinary_list",
        "mcp__qcc-risk__get_stock_pledge_info",
        "mcp__qcc-risk__get_pre_litigation_mediation",
        "mcp__qcc-risk__get_service_notice",
        "mcp__qcc-risk__get_simple_cancellation_info",
        "mcp__qcc-risk__get_valuation_inquiry",
        "mcp__qcc-risk__get_public_exhortation",
        "mcp__qcc-risk__get_property_asset_announcement",
        "mcp__qcc-executive__get_executive_risk_scan",
        "mcp__qcc-executive__get_executive_related_risk_scan",
        ...
        "mcp__qcc-operation__get_random_check",
...
- `mcp__qcc-risk__get_dishonest_info` / `mcp__qcc-risk__get_judgment_debtor_info` / `mcp__qcc-risk__get_high_consumption_restriction` / `mcp__qcc-risk__get_terminated_cases` / `mcp__qcc-risk__get_equity_freeze` / `mcp__qcc-risk__get_equity_pledge_info` / `mcp__qcc-risk__get_chattel_mortgage_info` / `mcp__qcc-risk__get_land_mortgage_info` / `mcp__qcc-risk__get_business_exception` / `mcp__qcc-risk__get_tax_arrears_notice` / `mcp__qcc-risk__get_tax_violation` / `mcp__qcc-risk__get_administrative_penalty` / `mcp__qcc-risk__get_environmental_penalty` / `mcp__qcc-risk__get_serious_violation` / `mcp__qcc-risk__get_bankruptcy_reorganization` / `mcp__qcc-risk__get_liquidation_info`
- `mcp__qcc-risk__get_judicial_documents` / `mcp__qcc-risk__get_case_filing_info` / `mcp__qcc-risk__get_hearing_notice`（诉讼类）
...
- 关联方名单 / 集团归属等结构性信息仍可用 `mcp__qcc-company__get_external_investments` / `mcp__qcc-company__get_branches` 补充，但**风险面以先扫为准**，不退化为逐个扫描。
