...
{"version":1,"steps":[{"id":"litigation-entity","label":"确认企业主体","cap":"主体识别","capabilityKeys":["entity"],"completeOn":"route_match"},{"id":"litigation-risk","label":"检索涉诉与执行风险","cap":"风险数据","capabilityKeys":["risk"]},{"id":"litigation-history","label":"分析历史涉诉变化","cap":"历史数据","capabilityKeys":["history"]},{"id":"litigation-management","label":"核验关键人员涉诉","cap":"董监高数据","capabilityKeys":["management"]}]}
